...
/>
    ...
    <div className="RacksListMains">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div className="d-flex align-items-center px-2 TableDiv">
                                <div className="Changetext">
                                    <span>21 jul 2023 </span> <span>,</span> <span>03:01 pm</span>
                                </div>
                            </div>
                        </td>
                        <td>
                            ...
                            <div className="d-flex align-items-center px-2 TableDiv">
                                <div className="Changetext">
                                    ...
                                    {/* <LightGallery plugins={[lgZoom, lgFullScreen]}>
                                        <GalleryItem
                                        href='/images/avtarimg-eight.jpg'
                                        thumb={['/images/avtarimg-eight.jpg', 30, 30]}
                            ...
                            <div className="d-flex align-items-center px-2 TableDiv">
                                <div className="username">
                                    ...
                                    />
                                        ...
                                        <div className="Changetext"  onClick={handleUsernameClick}>
                                            <h2 className="my-0 ms-2" onClick={dataSaveShow}>
                                                {username}
                                            </h2>
                                        </div>
                                    )}
                        ...
                        <td>
                            <div className="d-flex align-items-center px-2 TableDiv">
                                <div className="Changetext">
                                    <span>Graphic Designing Consultant</span>
                                </div>
                            </div>
                        </td>
                        <td>
        ...
        <Offcanvas show={datasaveshow}  placement="bottom" className='SaveChangeCanvas'>

            <Offcanvas.Body closeButton>
                <div className="DataSaveClose d-flex align-items-center">
                    <Button type="submit" variant='primary'>Save</Button>
                    <Button className="ms-3" variant='outline-primary' onClick={dataSaveClose}>Cancel</Button>
